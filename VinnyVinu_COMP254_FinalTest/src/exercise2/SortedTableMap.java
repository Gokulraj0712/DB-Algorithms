...
public class SortedTableMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  public V putOnlyIfAbsent(K key, V value) throws IllegalArgumentException
  {
	  checkKey(key);
	  int i = findIndex(key);
  ...
  public static void main(String[] args) {
	  SortedTableMap<Integer,String> sortedMap = new SortedTableMap<>(); 
	  	sortedMap.putOnlyIfAbsent(1, "Apple");
	    sortedMap.putOnlyIfAbsent(2, "Orange");
	    sortedMap.putOnlyIfAbsent(3, "Peach");
	    sortedMap.putOnlyIfAbsent(4, "Mango");
	    ...
	    System.out.println("After trying to Add new elements");
	    sortedMap.putOnlyIfAbsent(1, "Banana");
	    sortedMap.putOnlyIfAbsent(1, "Kiwi");
	    
	    sortedMap.putOnlyIfAbsent(2, "Banana");
	    sortedMap.putOnlyIfAbsent(2, "Kiwi");
