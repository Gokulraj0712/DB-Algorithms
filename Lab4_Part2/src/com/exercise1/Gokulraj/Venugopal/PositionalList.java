...
public interface PositionalList<E> extends Iterable<E> {
   ...
   */
  public default Position<E> findPosition(E e) 
  {
  ...
  public static void main(String[] args) 
  {
	  ...
	  Position<String> a = list.addFirst("RED");
	  Position<String> b = list.addLast("BLUE");
	  Position<String> c = list.addAfter(b, "GREEN");
	  Position<String> d = list.addAfter(c, "BLACK");
	  Position<String> e = list.addLast("BLUE");
	  
	  Map<Position<String>, Character> positionMap = new HashMap<>();
	  char letter = 'a';
	  for (Position<String> p : list.positions()) {
	      positionMap.put(p, letter);
	      letter++;
	  }
	  
	  System.out.println(list);
	  
	  System.out.println("Position of RED : " + positionMap.get(list.findPosition("RED"))); 
	  System.out.println("Position of BLUE :  " + positionMap.get(list.findPosition("BLUE"))); 
	  System.out.println("Position of BLACK :  " +positionMap.get(list.findPosition("BLACK")));
	  System.out.println("Position of YELLOW :  " + positionMap.get(list.findPosition("YELLOW"))); 
