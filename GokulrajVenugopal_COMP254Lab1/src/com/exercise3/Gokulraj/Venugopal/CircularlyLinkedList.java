...
public class CircularlyLinkedList<E> {
  ...
  /**
   * Function to Clone Circular Linked List
   * 
   */
  ...
  {  
      ...
      if (size > 0) 
      {
          Node<E> originalListNode = tail.getNext();
          do 
          {
              other.addLast(originalListNode.getElement());
              originalListNode = originalListNode.getNext();
          }   while(originalListNode != tail.getNext());
      }
      return other;
  }
  ...
  {
	  //Creating Circular list and adding values
	  ...
	  //Function call for Cloning the list to newList
      CircularlyLinkedList<String> newList = circularList.clone();
      System.out.println("\nCloned List:");
