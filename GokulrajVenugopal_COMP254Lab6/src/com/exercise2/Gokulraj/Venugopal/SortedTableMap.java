...
public class SortedTableMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  public static void main(String[] args) {
      ...
      System.out.println(map.containKey("one")); // true
      System.out.println(map.containKey("two")); // true
      System.out.println(map.containKey("three")); // true
      System.out.println(map.containKey("four")); // false
  }

  /***
   * In this example, we create a SortedTableMap instance and add three key-value 
   * pairs to it using the put method. We then test the containsKey method by 
   * calling it with keys that exist in the map and a key that does not exist in 
   * the map. The output shows that the containsKey method correctly identifies 
   * whether each key exists in the map or not.
   */
