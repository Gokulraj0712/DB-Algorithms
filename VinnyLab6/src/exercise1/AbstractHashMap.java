...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  private double loadFactor;           // maximum load factor
  ...
  /** Creates a hash table with given capacity and prime factor 109345121. */
	  public AbstractHashMap(int cap, double loadFactor) { this(cap, 109345121, loadFactor); }  // default prime

  /** Creates a hash table with capacity 17 and prime factor 109345121. */
	  public AbstractHashMap(double loadFactor) { this(17, loadFactor); }                     // default capacity
	                       // default capacity
  ...
  public V put(K key, V value) {
	  V answer = bucketPut(hashValue(key), key, value);
	    if ((double) n / capacity > loadFactor)              // keep load factor <= 0.5
